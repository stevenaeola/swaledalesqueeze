...
function rhcontent(){
   box("<h1>Tutors</h1>
<p>The guest tutors for the 2017 squeeze are Roisin Broderick (Anglo),
Dave Townsend (English) and John Morgan (Duet), with additional workshops from Rosie Bryson (Anglo and Scandinavian tunes for all systems). Our regular tutors are  Alex Wade (English), Harry Scurfield (Anglo), Paul Walker (English/Anglo), Carolyn Wade (Band)  and Dave Ball (Band/English). Together they provide workshops covering a whole range of concertina playing for different abilities, systems and styles.
</p>");

  box("<h1>Timetable</h1>
<p>
The weekend starts on Friday 19th May. We have two informal sessions including the Dotty session, with written music provided for the tunes. Saturday includes teaching workshops in the morning and afternoon, an informal tea-time concert and a ceilidh in the evening at Reeth Memorial Hall, with the band for the ceilidh and the 'spots' provided by participants. There are more workshops on Sunday morning before the farewell concert on Sunday afternoon, again in Reeth Memorial Hall, featuring spots from the tutors and their workshop groups. </p>");
